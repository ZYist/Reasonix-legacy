...
- [ ] **Phase 1: Web Panel Removal** - 切除 dashboard/ + src/server/ 及 CLI 内部面板适配代码,CLI/TUI 无面板运行
...
Plans:
- [ ] 02-01: 从 `src/cli/commands/desktop.ts` 提取传输协议无关的"无头对话宿主"(对话循环 / 暂停门 / 工具集),核心复用不重复实现

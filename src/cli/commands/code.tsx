/** `reasonix-legacy code [dir]` — native filesystem tools + code system prompt, wraps `chat`. */
...
export async function codeCommand(opts: CodeOptions = {}): Promise<void> {
  ...
  // pick up a key the user already configured via `reasonix-legacy setup`. chatCommand

...
- standalone command and TUI connection paths
...
- If credentials are needed, tell the user to enter them only in:
  ...
  - \`~/.reasonix/config.json\` / supported QQ environment variables outside the chat transcript.
...
- First figure out whether they are using the standalone command or a TUI connection.
...
- Current configuration guide: https://github.com/ZYist/reasonix-legacy/blob/dev/docs/configuration.md
- Current QQ guide (zh): https://github.com/ZYist/reasonix-legacy/blob/dev/docs/qq-connect.zh-CN.md
